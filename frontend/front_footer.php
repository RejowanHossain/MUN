                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="footer-widget">
                            <img src="frontend/assets/img/logo-white.png" class="img-footer" alt="" />
    ...
    <!-- Scripts
			================================================== -->
    <script type="text/javascript" src="frontend/assets/plugins/js/jquery.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/viewportchecker.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/bootsnav.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/select2.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/wysihtml5-0.3.0.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/bootstrap-wysihtml5.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/datedropper.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/dropzone.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/loader.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/slick.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/gmap3.min.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/jquery.easy-autocomplete.min.js"></script>
    <!-- Custom Js -->
    <script src="frontend/assets/js/custom.js"></script>
    <script type="text/javascript" src="frontend/assets/plugins/js/counterup.min.js"></script>
